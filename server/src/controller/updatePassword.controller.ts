...
export const updatePassword = async (
    ...
    if (!verifyRes.success) {
        return res
            .status(400)
            .json(
                new ApiError(false, {}, "Failed", "Password Reset failed", 400),
            );
    }
            ...
            return res
                ...
                .json(
                    new ApiError(
                        ...
                        {},
                        "Failed",
                        "User don't Exist with this email",
                        400,
                    ),
                );
        }
            ...
            return res
                ...
                .json(
                    new ApiResponse(
                        ...
                        {},
                        "Success",
                        "Success Fully update the Password",
                        200,
                    ),
                );
        }
        ...
        return res
            ...
            .json(
                new ApiError(
                    ...
                    { error: error },
                    "Failed",
                    "Password update failed in catch",
                    400,
                ),
            );
    }
