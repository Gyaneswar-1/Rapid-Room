...
export const cancleReservation = async (req, res) => {
    ...
    if (!validData.success) {
        return res
            .status(400)
            .json(new ApiError(false, {}, "Failed", "Reservation cancelation failed due to insufficent or un formated data"));
    }
    try {
        ...
        return res.status(200).json(new ApiResponse(true, {}, "success", "Sucessfull cancel the resevation", 200));
    }
    catch (error) {
        return res
            .status(400)
