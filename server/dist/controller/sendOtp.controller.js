...
export const sendMail = async (req, res) => {
    ...
    try {
        ...
        if (emailRes) {
            ...
            if (dbRes) {
                return res.status(200).json(new ApiResponse(true, {}, "Success", "Successfully send the opt to ther client", 200));
            }
        }
        return res
            .status(400)
            .json(new ApiError(false, {}, "Failed", "Failed to send theo otp", 400));
        ...
        return res
            .status(400)
            .json(new ApiError(false, { error: error }, "Failed", "Failed to send theo otp in send otp controller", 400));
    }
};
// get emil in body
//generte the otp
