  ...
  return (
    <>
      <div className="font-EmCode">
        ...
        <div className="Welcome-textPage  border-amber-600  bg-scroll   bg-[url(https://digital.ihg.com/is/image/ihg/ihgor-member-rate-web-offers-1440x720)] relative bg-cover bg-center bg-dark-overlay bg-no-repeat ">
            ...
            <section className="">
              <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                ...
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
                  Book instantly, stay comfortably! RapidRoom offers a
                  seamless hotel booking experience with lightning-fast
