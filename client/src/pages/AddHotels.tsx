...
const allAmenities: AmenityItem[] = [
  ...
  { icon: FaBuilding, name: "Balcony", category: "basic", formKey: "hasBalcony" },
  { icon: FaDesktop, name: "WorkSpace", category: "basic", formKey: "hasWorkspace" },
  { icon: FaArchive, name: "Washing Machine", category: "basic", formKey: "hasWashingMachine" },
  { icon: FaFlask, name: "Garden", category: "basic", formKey: "hasGarden" },
  { icon: FaParking, name: "Parking", category: "basic", formKey: "hasParking" },
  { icon: FaSnowflake, name: "Air Conditioning", category: "basic", formKey: "hasAirConditioning" },
  { icon: FaUtensils, name: "Dining Area", category: "basic", formKey: "hasDiningArea" },

  { icon: FaSwimmingPool, name: "Pool", category: "standout", formKey: "hasPool" },
  { icon: FaHotTub, name: "Hot tub", category: "standout", formKey: "hasHotTub" },
  { icon: FaFire, name: "Firepit", category: "standout", formKey: "hasFirepit" },
  { icon: FaArchive, name: "BBQ grill", category: "standout", formKey: "hasBBQGrill" },
  { icon: FaArchive, name: "Pool table", category: "standout", formKey: "hasPoolTable" },
  { icon: FaArchive, name: "Exercise equipment", category: "standout", formKey: "hasExerciseEquipment" },
  { icon: FaUmbrellaBeach, name: "Outdoor shower", category: "standout", formKey: "hasOutdoorShower" },

  { icon: FaShieldAlt, name: "Smoke alarm", category: "safety", formKey: "hasSmokeAlarm" },
  { icon: FaShieldAlt, name: "First aid Kit", category: "safety", formKey: "hasFirstAidKit" },
  { icon: FaShieldAlt, name: "Fire extinguisher", category: "safety", formKey: "hasFireExtinguisher" },
  { icon: FaWheelchair, name: "Accessibility features", category: "safety", formKey: "hasAccessibility" },
]
...
const AddHotelForm = () => {
  ...
  const validateSection = async (currentSection: string, nextSection: string) => {
    ...
    switch (currentSection) {
      ...
      case "amenities":
        ...
        const hasAnyAmenity = allAmenities.some((amenity) => watch(amenity.formKey) === true)
        if (!hasAnyAmenity) {
  ...
  const selectedAmenitiesCount = allAmenities.filter((amenity) => watch(amenity.formKey) === true).length
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-teal-600 to-teal-700 px-6 py-8 sm:px-10">
              ...
              <p className="text-white mt-2 opacity-90">Fill out the form below to list your hotel on our platform</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-8 sm:px-10">
              ...
              <div className={activeSection === "basic" ? "block" : "hidden"}>
                ...
                {Object.keys(errors).some((key) =>
                  ["hotelName", "description", "price", "roomNumber", "guests", "beds", "bathrooms"].includes(key),
                ) && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="col-span-1 md:col-span-2">
                    ...
                    />
                    {errors.hotelName && <p className="mt-1 text-sm text-red-600">{errors.hotelName.message}</p>}
                  </div>
              ...
              <div className={activeSection === "amenities" ? "block" : "hidden"}>
                    ...
                    {basicAmenities.map((amenity, index) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() => handleAmenitySelection(amenity.formKey)}
                        >
                          {isSelected && (
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <h3 className="font-medium text-gray-900 mb-2">Selected Amenities ({selectedAmenitiesCount})</h3>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                      {images.map((url, index) => (
                        <div key={index} className="rounded-lg overflow-hidden shadow-sm border border-gray-200 h-24">
