...
const AddHotelForm = () => {
  ...
  useEffect(() => {
    register("amenities", {
      validate: (value) =>
        selectedAmenities.size > 0 || "Please select at least one amenity",
    });
              ...
              <div className={activeSection === "basic" ? "block" : "hidden"}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="col-span-1 md:col-span-2">
                    ...
                    <input
                      {...register("title", {
                        required: "Hotel title is required",
                      })}
                      type="text"
                    ...
                    {hotelTypes.map((type) => (
                      <label key={type.value} className="relative">
                        ...
                        <div className="flex items-center justify-center p-3 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 peer-checked:border-primary peer-checked:bg-teal-50 transition-colors cursor-pointer">
                          <span className="font-medium peer-checked:text-primary capitalize">
                            {type.label}
                          </span>
                        </div>
                      </label>
