            ...
            {(isMobileMenuOpen || window.innerWidth >= 768) && (
              <motion.div
                ...
                className={`md:col-span-1 ${
                  isMobileMenuOpen ? "fixed inset-0 z-50 pt-20 px-4 pb-4 bg-gray-900 bg-opacity-50" : "relative z-10"
                    ...
                    <ul>
                      <li>
                        ...
                        >
                          <div className="flex items-center">
                            <User
                              className={`w-5 h-5 mr-3 ${activeTab === "personal-info" ? "text-teal-500" : "text-gray-400"}`}
                            />
                            <span className="font-medium">Personal Info</span>
                          </div>
                          {activeTab === "personal-info" && <ChevronRight className="w-4 h-4" />}
                        </button>
                      </li>
                      <li>
                        <button
                        ...
                        >
                          <div className="flex items-center">
                            <Calendar
                              className={`w-5 h-5 mr-3 ${activeTab === "bookings" ? "text-teal-500" : "text-gray-400"}`}
                            />
                      ...
                      <li>
                        ...
                        >
                          <div className="flex items-center">
                            <Star
                              className={`w-5 h-5 mr-3 ${activeTab === "reviews" ? "text-teal-500" : "text-gray-400"}`}
                            />
                            <span className="font-medium">My Reviews</span>
                          </div>
                          {activeTab === "reviews" && <ChevronRight className="w-4 h-4" />}
                        </button>
                      </li>
                      <li>
                        <button
                        ...
                        >
                          <div className="flex items-center">
                            <MessageSquare
                              className={`w-5 h-5 mr-3 ${activeTab === "messages" ? "text-teal-500" : "text-gray-400"}`}
                            />
                            <span className="font-medium">Messages</span>
                          </div>
                          {activeTab === "messages" && <ChevronRight className="w-4 h-4" />}
                        </button>
                      </li>
                    </ul>
                  </nav>
            ...
            >
              ...
              {activeTab === "personal-info" && (
                <div>
                  ...
                  {!isEditing && (
                    <div className="mt-6">
                      <h3 className="text-sm font-medium text-gray-500 mb-3">MY WISHLIST</h3>
                              ...
                              <div className="flex justify-between items-center mt-1">
                                <div className="flex items-center">
                                  ...
                                  <span className="ml-1 text-xs font-medium">
                                    {item === 1 ? "4.9" : item === 2 ? "4.7" : "4.8"}
                                  </span>
                                </div>
                                <p className="font-medium text-xs text-teal-600">
                                  ${item === 1 ? "320" : item === 2 ? "180" : "450"}
                        ...
                        <div className="flex-1 p-4 md:p-6 flex flex-col justify-between">
                          <div>
                            <div className="flex justify-between items-start">
                              <div>
                                <h3 className="text-xl font-bold text-gray-800">Grand Plaza Hotel</h3>
                            ...
                            <div className="mt-4">
                              ...
                              <p className="text-lg font-bold text-teal-600">$1,250</p>
                            </div>
                          </div>
                      ...
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex-1 p-4 md:p-6 flex flex-col justify-between">
                          <div>
                            <div className="flex justify-between items-start">
                              <div>
                                <h3 className="text-xl font-bold text-gray-800">Mountain Retreat</h3>
                            ...
                            <div className="mt-4">
                              <p className="text-sm text-gray-500">Total Price</p>
                              <p className="text-lg font-bold text-teal-600">$950</p>
                            </div>
                          </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-2/3">
                      <div className="bg-white rounded-xl border p-6 mb-6">
                        <div className="flex justify-between items-start mb-4">
                          <div>
                            <h3 className="text-xl font-bold text-gray-800">{selectedBooking.name}</h3>
                        ...
                        <div className="border-t border-gray-100 pt-4 mb-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{selectedBooking.bookedOn}</p>
                            </div>
                          </div>
                        </div>

                        <div className="border-t border-gray-100 pt-4">
                          <h4 className="font-medium text-gray-800 mb-3">Host Information</h4>
                          <div className="flex items-center">
                            <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center text-teal-600 mr-3">
                              <span className="font-bold">{selectedBooking.hostName.charAt(0)}</span>
                            </div>
                            <div>
                              <p className="font-medium">{selectedBooking.hostName}</p>
                              <p className="text-sm text-gray-500">{selectedBooking.hostContact}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border p-6">
                        <h4 className="font-medium text-gray-800 mb-3">Property Policies</h4>
                    ...
                    <div className="md:w-1/3">
                      <div className="bg-white rounded-xl border p-6 sticky top-6">
                        <h4 className="font-medium text-gray-800 mb-4">Price Details</h4>
                        <div className="space-y-2 mb-4">
                          <div className="flex justify-between">
                            <p className="text-gray-600">Room rate</p>
                            <p className="font-medium">
                              ${Number.parseInt(selectedBooking.price.replace(/[^0-9]/g, "")) * 0.8}
                            </p>
                          </div>
                          <div className="flex justify-between">
                            <p className="text-gray-600">Taxes & fees</p>
                            <p className="font-medium">
                              ${Number.parseInt(selectedBooking.price.replace(/[^0-9]/g, "")) * 0.2}
                            </p>
                          </div>
                          <div className="border-t border-gray-100 pt-2 mt-2">
                            <div className="flex justify-between font-bold">
                              <p>Total</p>
                              <p className="text-teal-600">{selectedBooking.price}</p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                      <div className="flex flex-col md:flex-row gap-4">
                        <div className="md:w-1/4">
                          ...
                          />
                          <h3 className="font-medium text-gray-800 mt-2">Luxury Downtown Apartment</h3>
                        ...
                        <div className="md:w-3/4">
                          ...
                          <p className="text-gray-700 mb-4">
                            Amazing place! The apartment was spotless, beautifully decorated, and in a perfect location.
                            The host was very responsive and accommodating. Would definitely stay here again!
                          </p>
                      ...
                      <div className="flex flex-col md:flex-row gap-4">
                        <div className="md:w-1/4">
                          <img
                            ...
                            className="w-full h-32 object-cover rounded-lg"
                          />
                          <h3 className="font-medium text-gray-800 mt-2">Beachfront Villa</h3>
                          <p className="text-sm text-gray-500 flex items-center">
                        ...
                        <div className="md:w-3/4">
                          ...
                          <p className="text-gray-700">
                            Great location right on the beach! The villa was spacious and comfortable. The only issue
                            was the air conditioning in one of the bedrooms wasn't working properly, but the host was
                            quick to address it.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-white border rounded-xl overflow-hidden">
                    {[
                      ...
                      <div key={message.id}>
                        <div className={`p-4 hover:bg-gray-50 transition-colors ${message.unread ? "bg-teal-50" : ""}`}>
                          <div className="flex justify-between items-start">
                            <div className="flex items-start">
                              <div
                                className={`w-10 h-10 rounded-full ${message.isReceived ? "bg-teal-100 text-teal-600" : "bg-blue-100 text-blue-600"} flex items-center justify-center mr-3`}
                              >
                                <span className="font-bold">{message.isReceived ? message.sender.charAt(0) : "Y"}</span>
                              </div>
                              <div>
                                <div className="flex items-center">
                                  <h3 className="font-bold text-gray-800">
                                    {message.isReceived ? message.sender : `You → ${message.recipient}`}
                                  </h3>
                        ...
                        {index < array.length - 1 && <div className="border-t border-gray-100"></div>}
                      </div>
                    ))}
                  </div>
